                ...
                <fieldset><legend> DatiContratto </legend>
                    ...
                    <div class="row g-1">
                        <div class="col">  
                            ...
                            <input id="Data2" type="date" name="Data" value="{{ old('Data2') }}" placeholder="2016-09-01" class="form-control @error('Data2') is-invalid @enderror">
                            @error('Data2')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror                   
                        </div>
                ...
                <fieldset><legend> DatiConvenzione </legend>
                    ...
                    <div class="row g-1">
                        <div class="col">  
                            ...
                            <input id="Data3" type="date" name="Data" value="{{ old('Data3') }}" placeholder="2016-09-01" class="form-control @error('Data3') is-invalid @enderror">
                            @error('Data3')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror                   
                        </div>
