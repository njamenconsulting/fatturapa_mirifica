...
class XmlGeneratorService
{
    public static function XmlGenerator($array)
    {
        ...
        for ($i = 0; $i < $nbLinesAdded; $i++) 
        {

            $DettaglioLinee[$i+1] = array(
                                        'NumeroLinea'    => $i+1,
                                        'Descrizione'    => $array['Descrizione'][$i],
                                        'Quantita'       => $array['Quantita'][$i],
                                        'PrezzoUnitario' => $array['PrezzoUnitario'][$i],
                                        'PrezzoTotale'   => $array['PrezzoTotale'][$i],
                                        'AliquotaIVA'    => $array['AliquotaIVA'][$i]
                                    );         
        }
